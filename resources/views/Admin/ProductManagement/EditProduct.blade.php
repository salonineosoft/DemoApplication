        ...
        <form class="text-center m-auto" action="/products/{{$data->id}}" method="Post" enctype="multipart/form-data">
            ...
            <div class="form-check-inline">
                <label class="form-check-label">
                    <input type="radio" class="form-check-input" name="status" value="{{$data->status}}" value="active" {{($data->status =="active")?'checked':''}}>active
                </label>
            </div>
           <div class="form-check-inline">
                <label class="form-check-label">
                    <input type="radio" class="form-check-input" name="status" value="{{$data->status}}" value="inactive" {{($data->status =="inactive")?'checked':''}}>inactive
                </label>
           </div>
            </div><br>
            <div class="image">
