...
<div class="bg-white">
  ...
  <a href="categories/create" class="btn btn btn-primary mr-3 mt-3">AddCateory
  ...
  <tbody>
   @if(count($data)>0) 
    ...
    <tr>
      ...
      @endif
      <td class="m-auto">
        <a href="categories/{{$i->id}}/edit" class="btn btn-success"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
